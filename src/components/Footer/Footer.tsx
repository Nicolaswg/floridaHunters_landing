...
export const Footer = ({ description, socialLinks, address }: FooterProps) => {
  return (
    <footer>
      <div className="flex flex-col p-6 py-10 text-gray-400 bg-gray-800 md:px-8 md:grid md:grid-cols-3">
        <div className="flex flex-col gap-6 md:col-span-3 lg:col-span-2 md:flex-row">
          <iframe
