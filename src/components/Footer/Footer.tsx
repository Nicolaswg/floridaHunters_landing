        ...
        <div className="md:col-span-3 lg:col-span-2 flex flex-col md:flex-row gap-6">
          ...
          <div className="grow flex flex-col justify-between">
            ...
            <div className="flex items-center mt-1 space-x-3">
              <a target="_blank" href={socialLinks[0].links} className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              ...
              <a target="_blank" href={socialLinks[1].links} className="text-gray-500 transition-colors duration-300 hover:text-deep-purple-accent-400">
              ...
              <a target="_blank" href={socialLinks[2].links}>
              ...
              <a target="_blank" href={socialLinks[3].links}>
                <svg xmlns="http://www.w3.org/2000/svg" width="25" height="25" fill="none" viewBox="0 0 1200 1227"><path fill="#fff" d="M714.163 519.284 1160.89 0h-105.86L667.137 450.887 357.328 0H0l468.492 681.821L0 1226.37h105.866l409.625-476.152 327.181 476.152H1200L714.137 519.284h.026ZM569.165 687.828l-47.468-67.894-377.686-540.24h162.604l304.797 435.991 47.468 67.894 396.2 566.721H892.476L569.165 687.854v-.026Z" /></svg>
              </a>
            </div>
          </div>
        </div>
