...
export const Header = () => {
  return (
    <header className='fixed top-0 w-full z-10 backdrop-blur-[.2em] bg-gray-900/40'>
          ...
          <div className="flex items-center justify-between">
            <div className="flex w-full lg:justify-between gap-2 space-x-4">
              ...
              <div className="hidden md:flex items-center space-x-1">
                <a href="/" className={`flex gap-x-2 sm:text-[18px] sm:truncate lg:text-xl text-base py-5 px-3 text-white hover:text-[#94F7F6] ease-in-out duration-300 ${buttonVariants({ variant: 'link' })}`}>
